                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        ...
                        <div className="flex flex-col items-center text-center">
                            ...
                            <p className="text-slate-500 flex-1 leading-relaxed">
                                Upon confirmed payment, your personal access code is physically provisioned to the property's YAMIRY smart locks, valid exactly for the duration of your stay.
                            </p>
                        </div>
